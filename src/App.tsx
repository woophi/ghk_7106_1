...
export const App = () => {
  ...
  const goToStep2 = () => {
    window.gtag('event', '7106_open_pds', { var: 'var1' });
  ...
  const goToConfirmStep3 = () => {
    window.gtag('event', '7106_pay_pds', { var: 'var1' });
      ...
      <>
        ...
        <div className={appSt.bottomBtn()}>
          <Button
            ...
            view="primary"
            onClick={() => {
              window.gtag('event', '7106_pay_deposit_var1');
              setSteps('step4');
            }}
          >
            Оплатить вклад
      ...
      <div style={{ backgroundColor: '#494949', minHeight: '100dvh' }}>
        ...
        <div className={appSt.bottomBtn({ confirmed: true })}>
          <Button
            ...
            view="secondary"
            onClick={() => {
              window.gtag('event', '7106_open_deposit_after_pds', { var: 'var1' });
              setSteps('step3');
            }}
    ...
    <>
        ...
        <div className={appSt.containerB}>
          ...
          {faqs.map((faq, index) => (
            <div key={index}>
              <div
                onClick={() => {
                  window.gtag('event', '7106_bundle_faq', { faq: String(index + 1), var: 'var1' });
      ...
      <div className={appSt.bottomBtn()}>
        <Button
          ...
          view="primary"
          onClick={() => {
            window.gtag('event', '7106_start_open_bundle', { var: 'var1' });
            setSteps('step1');
          }}
        >
          Открыть Вклад + ПДС
